...
#data_tg <- data[data$ISO.code=="TGO",c("Date","Daily.change.in.cumulative.total","Cumulative.total","Daily.change.in.cumulative.total.per.thousand","Cumulative.total.per.thousand","X7.day.smoothed.daily.change","X7.day.smoothed.daily.change.per.thousand")]
# colnames(data_tg)=c("Dates","DailyTests","CumTests","DailyTestsK","CumTestsK","SmoothedTests","SmoothedTestsK")
...
df_tg[which(df_tg$Dates==data_tg$Dates[1]):which(df_tg$Dates==data_tg$Dates[nrow(data_tg)]),c(15:19)] = data_tg[,-1]
